  ...
  return (
    <div className="climate-body flex flex-col mainContainer">
      ...
      <div className="global-warming-section">
        ...
        <p>
          These two images illustrate the progression of global warming impacts
          over time, as predicted by the IPCC (Intergovernmental Panel on
        ...
        <div className="timeline-images">
          <div className="image-description">
            ...
            />
            <p>
              <strong>Before 2020:</strong> This timeline showcases the initial
              impacts of global warming, focusing on the period up to 2020. It
              highlights a gradual increase in global temperatures, affecting
              ecosystems such as forests, coral reefs, and various animal
              species. Key points include:
            </p>
            <ul>
          ...
          <div className="image-description">
            ...
            <p>
              ...
              thresholds and their cascading effects on global biodiversity. Key
              points include:
            </p>
            <ul>
              <li>
              ...
              <li>
                Accelerated coral reef degradation and species extinction risks.
              </li>
              <li>
                High-impact events like droughts, floods, and wildfires becoming
                more common.
              </li>
            </ul>
          </div>
      ...
      <div className="interactive-section">
        ...
        <div className={`facts-section ${showFacts ? "expanded" : ""}`}>
          ...
          <ul>
            ...
            <li>
              Forest fires, intensified by climate change, destroy habitats for
              countless species.
            </li>
          </ul>
